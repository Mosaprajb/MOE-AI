...
<style>
:root{color-scheme:dark;font-family:Inter,system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}*{box-sizing:border-box}body{margin:0;min-height:100vh;background:radial-gradient(circle at top,#10243d 0,#07111f 38%,#050b14 100%);color:#edf4ff}.wrap{max-width:1500px;margin:auto;padding:20px}header{display:flex;align-items:center;justify-content:space-between;gap:18px;margin-bottom:16px}h1{margin:0;font-size:clamp(27px,4vw,42px);letter-spacing:-.04em}h2{margin:0 0 12px;font-size:19px}.muted{color:#8fa4bf}.toolbar,.live,.tabs{display:flex;gap:9px;align-items:center;flex-wrap:wrap}.live{color:#7ee2a8;font-weight:800}.dot{width:10px;height:10px;border-radius:50%;background:#39d98a;box-shadow:0 0 18px #39d98a}button{border:1px solid #2b4566;background:#10233b;color:#edf4ff;border-radius:12px;padding:10px 13px;cursor:pointer}.grid{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:12px}.card{background:linear-gradient(145deg,rgba(16,35,59,.96),rgba(7,17,31,.96));border:1px solid #1d3552;border-radius:18px;padding:16px;box-shadow:0 18px 60px rgba(0,0,0,.22)}.metric{margin-top:7px;font-size:clamp(23px,3vw,33px);font-weight:900;font-variant-numeric:tabular-nums}.section{margin-top:14px}.intel{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.analytics{display:grid;grid-template-columns:1.3fr .7fr;gap:14px}.risk-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.risk-box{padding:13px;border:1px solid #203a58;border-radius:14px;background:#0a1726}.risk-value{font-size:23px;font-weight:900;margin-top:6px}.positive{color:#7ee2a8}.negative{color:#ff9696}.neutral-text{color:#ffd07a}.pill,.badge{display:inline-flex;align-items:center;border-radius:999px;font-size:11px;font-weight:800}.pill{padding:6px 10px}.badge{padding:5px 9px}.bull,.ok{background:rgba(57,217,138,.14);color:#7ee2a8}.bear,.no{background:rgba(255,99,99,.14);color:#ff9696}.neutral,.watch{background:rgba(255,191,71,.14);color:#ffd07a}.chart-shell{height:250px;position:relative}.chart-shell canvas{width:100%;height:100%}.heatmap{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.heat{border-radius:13px;padding:12px;min-height:79px;border:1px solid rgba(255,255,255,.08);display:flex;flex-direction:column;justify-content:space-between}.heat strong{font-size:17px}.heat small{color:#d5dfec}.portfolio{display:grid;grid-template-columns:repeat(3,1fr);gap:9px}.position{padding:13px;border:1px solid #203a58;border-radius:14px;background:#091523}.position-head{display:flex;justify-content:space-between;gap:8px}.position-line{display:flex;justify-content:space-between;color:#a9bbd1;font-size:12px;margin-top:8px}.table-wrap{overflow:auto;border-radius:15px;border:1px solid #1c304a}table{width:100%;border-collapse:collapse;min-width:1160px;background:#091523}th,td{padding:12px 13px;text-align:right;border-bottom:1px solid #172a41;vertical-align:middle}th{color:#8fa4bf;font-size:11px;background:#0d1b2d;position:sticky;top:0;z-index:1}.score{font-weight:900}.reason{max-width:310px;white-space:normal;color:#b5c4d8}.empty{padding:30px;text-align:center;color:#8fa4bf}.tab.active{background:#1a4069;border-color:#3e6f9f}.footer{padding:16px 4px 0;color:#748aa6;font-size:12px;text-align:center}@media(max-width:1100px){.grid{grid-template-columns:repeat(3,1fr)}.intel{grid-template-columns:repeat(2,1fr)}.analytics{grid-template-columns:1fr}.portfolio{grid-template-columns:repeat(2,1fr)}}@media(max-width:700px){.wrap{padding:13px}header{align-items:flex-start;flex-direction:column}.grid{grid-template-columns:repeat(2,1fr)}.intel,.risk-grid{grid-template-columns:repeat(2,1fr)}.portfolio{grid-template-columns:1fr}.heatmap{grid-template-columns:repeat(2,1fr)}}
</style>
...
<div class="footer">الأرباح والخسائر المعروضة هنا تقديرات مخططة من أسعار الدخول والوقف والهدف والكمية المسجلة، وليست رصيدًا حيًا من Webull. يتم التحديث كل 10 ثوانٍ.</div>
</main><script>
