...
const DEFINITIONS = Object.freeze({
  ...
  [STRATEGY_IDS.MOERAND_CLEAN_INTERNAL]: Object.freeze({
    ...
    settings: Object.freeze({
      keyValue: Object.freeze({ env: 'MOERAND_CLEAN_KEY_VALUE', type: 'number', defaultValue: 1, minimum: 0.1, maximum: 100 }),
      atrPeriod: Object.freeze({ env: 'MOERAND_CLEAN_ATR_PERIOD', type: 'integer', defaultValue: 2, minimum: 1, maximum: 500 }),
      useHeikinAshi: Object.freeze({ env: 'MOERAND_CLEAN_USE_HEIKIN_ASHI', type: 'boolean', defaultValue: false }),
      ...
      timeframeMinutes: Object.freeze({ env: 'MOERAND_CLEAN_TIMEFRAME_MINUTES', type: 'integer', defaultValue: 5, minimum: 1, maximum: 15 }),
    }),
    aliases: Object.freeze([
      'MOERAND_CLEAN',
      'CLEAN',
